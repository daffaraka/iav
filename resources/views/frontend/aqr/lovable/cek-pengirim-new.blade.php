...
<div class="max-w-lg w-full space-y-8 animate-fade-in-up">
    <div class="bg-white rounded-2xl shadow-2xl p-8 border-0">
        ...
        <div class="space-y-4">
            <!-- Masyarakat Umum -->
            <a href="{{ route('helpdesk.demo.cek-pengirim', ['pengirim' => 'Masyarakat Umum']) }}"
            ...
            <!-- Warga Sekolah -->
            <a href="{{ route('helpdesk.demo.cek-pengirim', ['pengirim' => 'Warga Sekolah']) }}"
