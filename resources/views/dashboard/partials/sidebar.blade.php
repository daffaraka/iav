<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Avicenna</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('dashboard/aqr/*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle {{ request()->is('aqr*') ? 'active' : '' }}">
        ...
        @role('super-admin')
            ...
            <li class="menu-item {{ request()->is('sekolah*') ? 'active' : '' }}">
