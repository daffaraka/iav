                    ...
                    <form action="{{ route('aqr-option.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select class="form-control @error('kategori_pic') is-invalid @enderror" id="kategori_pic"
                                    name="kategori_pic" required>
                                    <option value="">Pilih Kategori PIC</option>
                                    <option value="Kepala Sekolah"
                                        {{ old('kategori_pic') == 'Kepala Sekolah' ? 'selected' : '' }}>
                                        Kepala Sekolah
                                    </option>
                                    <option value="Kepala TU" {{ old('kategori_pic') == 'Kepala TU' ? 'selected' : '' }}>
                                        Kepala TU
                                    </option>
                                    <option value="Psikolog" {{ old('kategori_pic') == 'Psikolog' ? 'selected' : '' }}>
                                        Psikolog
                                    </option>
                                </select>
                                @error('kategori_pic')
