...
export default function MasterGuruEdit({ guru, guru_role }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(`/master-guru/${guru.id}`);
    };

    return (
        <AuthenticatedLayout>
            <Head title="Edit Master Guru" />

            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Edit Master Guru</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Perbarui informasi guru</p>
                </div>
                <Link 
                    href="/master-guru" 
