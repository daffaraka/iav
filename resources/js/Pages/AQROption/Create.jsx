...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tambah AQR Option" />

            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Tambah AQR Option</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Tambahkan opsi baru untuk AQR</p>
                </div>
                <Link 
                    href="/aqr-option" 
            ...
            <div className="bg-white dark:bg-surface-800 rounded-2xl border border-surface-100 dark:border-surface-700 shadow-soft p-6 transition-colors duration-300">
                <form onSubmit={submit} className="space-y-6 max-w-2xl">
                    ...
                    <div className="pt-4 flex items-center justify-end">
                        ...
                        >
                            {processing ? 'Menyimpan...' : 'Simpan Option'}
                        </button>
                    </div>
                </form>
            </div>
