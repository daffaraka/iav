...
export default function PrestasiGuruEdit({ prestasi, users }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/prestasi-guru/${prestasi.id}`);
    };

    return (
        <AuthenticatedLayout>
            <Head title="Edit Prestasi Guru" />
            ...
            <div className="bg-white dark:bg-surface-800 rounded-2xl shadow-soft border border-surface-200 dark:border-surface-700 p-6">
                <h2 className="text-xl font-bold text-slate-800 dark:text-white mb-6">Edit Data Prestasi Guru</h2>
