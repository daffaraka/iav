...
export default function PrestasiGuruCreate({ users }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        penyelenggara: '',
        level_lomba: 'Kota/Kabupaten',
        tahapan_lomba: 'Event',
        kategori_lomba: 'Individual',
        status_kurasi: 'Terkurasi',
        lanjutan_status_kurasi: 'Sudah diajukan kurasi',
    });
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tambah Prestasi Guru" />

            <div className="mb-6">
                <Link href="/prestasi-guru" className="text-brand-600 hover:text-brand-700 flex items-center text-sm font-medium transition-colors">
                    <i className="ph ph-arrow-left mr-2"></i>
                    Kembali ke Data Prestasi Guru
                </Link>
            </div>

            <div className="bg-white dark:bg-surface-800 rounded-2xl shadow-soft border border-surface-200 dark:border-surface-700 p-6">
                <h2 className="text-xl font-bold text-slate-800 dark:text-white mb-6">Tambah Data Prestasi Guru</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-1">
                            <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Nama Guru / Staf</label>
                            <select
                                value={data.user_id}
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                placeholder="Contoh: Menulis, Mengajar, Futsal"
                                className="w-full rounded-xl border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-900 text-slate-800 dark:text-slate-200 focus:ring-brand-500 focus:border-brand-500"
                            />
                        ...
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                placeholder="Contoh: Juara 1, Peserta Terbaik"
                                className="w-full rounded-xl border-surface-300 dark:border-surface-600 bg-white dark:bg-surface-900 text-slate-800 dark:text-slate-200 focus:ring-brand-500 focus:border-brand-500"
                            />
