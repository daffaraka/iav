...
export default function MasterKelasCreate({ guru }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tambah Master Kelas" />

            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-white">Tambah Master Kelas</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Masukkan informasi kelas baru</p>
                </div>
                <Link 
                    href="/master-kelas" 
