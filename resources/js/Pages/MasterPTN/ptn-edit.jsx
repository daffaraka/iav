...
export default function PtnEdit({ MasterPt }) {
    const { data, setData, put, processing, errors } = useForm({
        nama_pt: MasterPt.nama_pt || '',
        status_pt: MasterPt.status_pt || '',
        lokasi: MasterPt.lokasi || '',
        provinsi: MasterPt.provinsi || '',
        kota: MasterPt.kota || ''
    });
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Edit Data PTN/PTS" />

            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Edit PTN/PTS</h1>
