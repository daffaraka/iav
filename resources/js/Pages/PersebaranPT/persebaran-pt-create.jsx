...
export default function PtCreate({ ptns, siswas }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tambah Data Persebaran PTN/PTS" />

            <div className="p-4 sm:p-8">
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-800 dark:text-white tracking-tight">Tambah Persebaran</h1>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Masukkan data persebaran siswa ke Perguruan Tinggi</p>
                        </div>
                        <Link
                            href="/persebaran-ptn"
