...
export default function PrestasiSiswaIndex({ prestasi, flash }) {
    ...
    const confirmDelete = () => {
        destroy('/prestasi-siswa/' + confirmModal.id);
        ...
        },
        {
            ...
            cell: info => (
                <div className="flex items-center gap-1.5 flex-wrap">
                    <Link
                        href={`/prestasi-siswa/${info.row.original.id}/edit`}
        ...
        <AuthenticatedLayout>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola dan pantau data prestasi seluruh siswa.</p>
                </div>
                <div className="flex gap-3">
                    <Link
                        href="/prestasi-siswa/create"
            ...
            <ConfirmModal
                ...
                title="Hapus Data Prestasi Siswa?"
