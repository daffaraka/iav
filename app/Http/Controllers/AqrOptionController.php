...
class AqrOptionController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.aqr-option.index', compact('aqrOptions'));
    }

    public function create()
    {
        return view('dashboard.aqr-option.create');
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'kategori_pic' => 'required|in:Kepala Sekolah,Kepala TU'
        ]);
    ...
    {
        return view('dashboard.aqr-option.edit', compact('aqrOption'));
    }
